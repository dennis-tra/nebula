...
ALTER TABLE sessions ADD finish_reason dial_error;

-- Set all finish reason to 'unknown' for all finished sessions
UPDATE sessions SET finish_reason = 'unknown' WHERE finished = true;
...
ALTER TABLE sessions ADD CONSTRAINT con_finish_reason_not_null_for_finished CHECK (
