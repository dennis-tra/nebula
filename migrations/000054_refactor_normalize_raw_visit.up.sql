...
BEGIN
    ...
    SELECT upsert_peer(NEW.peer_multi_hash, coalesce(upserted_agent_version_id, NEW.agent_version_id), upserted_protocols_set_id, NEW.created_at) INTO upserted_peer_id;
