...
ax11.title.set_text("Agent Types (Total %s)" % format(agent_names_total, ','))
...
ax21.title.set_text("go-ipfs Versions Distribution (Total %s)" % format(go_ipfs_versions_total, ','))
...
ax31.title.set_text("go-ipfs v0.8.0 Versions Distribution (Total %s)" % format(go_ipfs_v08_versions_total, ','))
