...
// Source: libp2p/driver_crawler.go
//
...
func (m *MockHost) IDService() identify.IDService {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IDService")
	ret0, _ := ret[0].(identify.IDService)
	return ret0
}

// IDService indicates an expected call of IDService.
func (mr *MockHostMockRecorder) IDService() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IDService", reflect.TypeOf((*MockHost)(nil).IDService))
}
