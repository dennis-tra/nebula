...
var (
	peerDBTypes = map[string]string{`MultiHash`: `text`, `UpdatedAt`: `timestamp with time zone`, `CreatedAt`: `timestamp with time zone`, `ID`: `integer`, `ProtocolsSetID`: `integer`, `AgentVersionID`: `integer`}
	_           = bytes.MinRead
)
