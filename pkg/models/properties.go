...
func (propertyL) LoadVisits(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProperty interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"visits\".id, \"visits\".peer_id, \"visits\".crawl_id, \"visits\".session_id, \"visits\".dial_duration, \"visits\".connect_duration, \"visits\".crawl_duration, \"visits\".visit_started_at, \"visits\".visit_ended_at, \"visits\".updated_at, \"visits\".created_at, \"visits\".type, \"visits\".error, \"a\".\"property_id\""),
		qm.From("\"visits\""),
