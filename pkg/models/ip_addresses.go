...
func (o *IPAddress) MultiAddressesXIPAddresses(mods ...qm.QueryMod) multiAddressesXIPAddressQuery {
...
func (ipAddressL) LoadMultiAddressesXIPAddresses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeIPAddress interface{}, mods queries.Applicator) error {
	var slice []*IPAddress
	...
	query := NewQuery(
		...
		qm.WhereIn(`multi_addresses_x_ip_addresses.ip_address_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets related.R.IPAddress appropriately.
func (o *IPAddress) AddMultiAddressesXIPAddresses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*MultiAddressesXIPAddress) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.IPAddressID = o.ID
