...
var (
	...
	//   https://github.com/ethereum/go-ethereum/blob/da55b23d21fb297fd01cfc1bebb13a3e8fe7f726/params/bootnodes.go#L67
	BootstrapPeersEthereum = []string{ // TODO: be more specific with regards to CL vs EL discv5
